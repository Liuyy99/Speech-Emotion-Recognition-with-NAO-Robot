...
# -*- coding: utf-8 -*-
"""
Usage: test_by_combined_testing_set.py

Description: test the model by the testing set of combined dataset (e corpus)
"""
...
tf.app.flags.DEFINE_string('testdata_path', './mel_4_datasets_40.pkl', 'total dataset includes training set')
