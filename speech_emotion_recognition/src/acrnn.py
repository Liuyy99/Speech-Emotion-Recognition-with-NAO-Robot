...
def acrnn(inputs, num_classes=4, is_training=True, L1=128, L2=256, cell_units=128, num_linear=768,
    ...
    # Feed `layer_3` into the LSTM BRNN cell and obtain the LSTM BRNN output.
