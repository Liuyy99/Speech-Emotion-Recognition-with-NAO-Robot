...
tf.app.flags.DEFINE_integer('num_epoch', 5001, 'The number of epoches for training.')
...
tf.app.flags.DEFINE_string('checkpoint1', './checkpoint_lr_0.00001_optimize_ua_4_dataset_combined_no_casia_iemocap/', 'the checkpoint1 dir')
tf.app.flags.DEFINE_string('checkpoint2', './checkpoint_lr_0.00001_optimize_ua_times_sad_4_dataset_combined_no_casia_iemocap/', 'the checkpoint2 dir')
...
def train():
    ...
    print("checkpoint path: ", FLAGS.checkpoint2)
    ##### For plotting #####  
    colors = {}
    ...
    with tf.Session() as sess:
        ...
        for i in range(FLAGS.num_epoch):
            ...
            if i % 5 == 0:
                ...
                valid_acc_uw_times_sad = valid_acc_uw * y_sad_acc[num_validate]
                
                if valid_acc_uw_times_sad >= best_valid_uw_times_sad:
                    best_valid_uw_times_sad = valid_acc_uw_times_sad
                ...
                print("Valid_UA*Sad: %3.4g" % valid_acc_uw_times_sad)
                print("Best Valid_UA: %3.4g" % best_valid_uw)
                print("Best Valid_UA_Sad: %3.4g" % best_valid_uw_times_sad)
                ...
                print(best_valid_conf_uw_times_sad)
                print("*****************************************************************")
                print("Valid size: ", total_angry + total_sad + total_happy + total_neutral)
    ...
    fig, (ax1, ax2, ax3, ax4, ax5, ax6, ax7) = plt.subplots(7, figsize = (12,18))
    ...
    ax5.set_title('Validation Sad vs. Neutral Acc')
    ...
    fig_name = "corrected_epochs_" + str(i) + "_4_dataset_combined_optimize_sad_no_casia_iemocap.png"
